...
export enum EQuestionCases {
  ...
  DEFAULT = `DEFAULT`,
  // casos especificos de inputs =>   CASE_1 = `${EFirstLevelCases.DIREITO_TRIBUTARIO}-${ESecondLevelCases.CONTENCIOSO}-${EThirdLevelCases.REPETICAO_INDEBITO}-${EFourthLevelCases.COBRANCA_TRIBUTO_INDEVIDO_EM_FACE_DA_LEGISLACAO_TRIBUTARIA_APLICAVEL}`,
}
